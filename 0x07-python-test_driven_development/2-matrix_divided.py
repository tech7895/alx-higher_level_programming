#!/usr/bin/python3
"""
This module comprises a function to divide the numbers of a matrix
...
def matrix_divided(matrix, div):
    ...
    Parameters:
        matrix: the list of integers/floats
        div: this divides the matrix
    ...
    Raises:
        TypeError: the elements of the matrix aren't lists
                   the elemetns of the lists aren't integers/floats
                   the div is not an integer/float number
