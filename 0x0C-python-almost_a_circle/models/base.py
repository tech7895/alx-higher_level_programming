...
class Base:
    ...
    def to_json_string(list_dictionaries):
        """This returns the JSON serialization of a list of dicts.
    ...
    def create(cls, **dictionary):
        """This returns a class instantied from a dictionary
        of attributes.
    ...
    def load_from_file_csv(cls):
        """This returns the list of classes instantiated from a CSV file.
